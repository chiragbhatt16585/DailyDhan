...
export const AFFILIATE_PLATFORMS = [
  ...
  },
  {
    ...
    icon: 'baby-buggy',
    color: '#FF6B6B',
    placeholder: 'Enter your First Cry affiliate link',
    description: 'First Cry Affiliate Program',
    website: 'https://www.firstcry.com/affiliate',
  },
  {
    id: 'ajio',
    name: 'Ajio',
    ...
    color: '#667eea',
    placeholder: 'Enter your Ajio affiliate link',
    description: 'Ajio Affiliate Program',
    website: 'https://www.ajio.com/affiliate',
  },
  {
    id: 'paytm',
    name: 'Paytm',
...
export const formatAffiliateLink = (platform, affiliateId, productUrl = '') => {
  ...
  const baseUrls = {
    ...
    firstcry: affiliateId.startsWith('http') ? affiliateId : `https://www.firstcry.com?affid=${affiliateId}`,
    ajio: affiliateId.startsWith('http') ? affiliateId : `https://www.ajio.com?affid=${affiliateId}`,
